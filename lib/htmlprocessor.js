...
//
var HTMLProcessor = module.exports = function (src, dest, content, revvedfinder, hostUrl, logcb) {
...
HTMLProcessor.prototype.replaceWithRevved = function replaceWithRevved(lines) {
    ...
    regexps.forEach(function (rxl) {
      ...
      content = content.replace(rxl[0], function (match, src) {
        ...
        if (self.hostUrl !== undefined && src !== file && file.charAt(0) === '/') {
          file = self.hostUrl + file;
        }
