...
//
var HTMLProcessor = module.exports = function (src, dest, content, revvedfinder, hostUrl, isContentFileRevved, logcb) {
...
HTMLProcessor.prototype.replaceWithRevved = function replaceWithRevved(lines) {
    ...
    regexps.forEach(function (rxl) {
      ...
      content = content.replace(rxl[0], function (match, src) {
        ...
        file = prependUrl(file, srcfile, self.hostUrl, self.isContentFileRevved);
